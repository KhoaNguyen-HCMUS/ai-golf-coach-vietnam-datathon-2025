        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex gap-1.5 rounded-lg border border-gray-200 bg-gray-50 p-1.5">
            <button
              ...
              className={`px-4 py-2 rounded-md font-semibold transition-all duration-300 flex items-center gap-2 ${mode === "player"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md font-semibold transition-all duration-300 flex items-center gap-2 ${mode === "coach"
                ? "bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-md"
                : "text-gray-600 hover:text-gray-900"
                }`}
            >
